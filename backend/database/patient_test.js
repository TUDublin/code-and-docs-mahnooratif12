...
const data = [
    ...
    {"id": 3, "age_id":4, "reference_id":6, "age_reference":true, "TCL":"RP","TFC":"Urea","test_name":"Urea", "unit":"mmol/L"},
    {"id": 4, "age_id":32, "reference_id":9, "age_reference":true, "TCL":"RP","TFC":"Crea","test_name":"Creatinine", "unit":"umol/L"},
    {"id": 5, "age_id":0, "reference_id":21, "age_reference":false, "TCL":"CRP","TFC":"CRP","test_name":"C Reactive Protein", "unit":"mg/L"},
    {"id": 6, "age_id":0, "reference_id":22, "age_reference":false, "TCL":"FLP","TFC":"Chol","test_name":"Cholesterol", "unit":"mmol/L"},
    {"id": 7, "age_id":0, "reference_id":23, "age_reference":false, "TCL":"FLP","TFC":"TRIG","test_name":"Triglceride", "unit":"mmol/L"},
    {"id": 8, "age_id":0, "reference_id":24, "age_reference":false, "TCL":"FLP","TFC":"LDL","test_name":"Low Density Lipoprotein - Cholestrol", "unit":"mmol/L"},
    {"id": 9, "age_id":0, "reference_id":25, "age_reference":false, "TCL":"FLP","TFC":"HDL","test_name":"High Density Lipoprotein - Cholesterol", "unit":"mmol/L"},
    {"id": 10, "age_id":0, "reference_id":27, "age_reference":false, "TCL":"FLP","TFC":"nonH","test_name":"nonHigh Density Lipoprotein - Cholesterol", "unit":"mmol/L"},
    {"id": 11, "age_id":5, "reference_id":28, "age_reference":true, "TCL":"TFT","TFC":"FT4","test_name":"Free thyroxine", "unit":"pmol/L"},
    {"id": 12, "age_id":5, "reference_id":33, "age_reference":true, "TCL":"TFT","TFC":"TSH","test_name":"Thyroid Stimulating Hormone", "unit":"mU/L"},
    {"id": 13, "age_id":4, "reference_id":40, "age_reference":true, "TCL":"LP","TFC":"PROT","test_name":"Total Protein", "unit":"g/L"},
    {"id": 14, "age_id":56, "reference_id":42, "age_reference":true, "TCL":"LP","TFC":"ALB","test_name":"Albumin", "unit":"g/L"},
    {"id": 15, "age_id":2, "reference_id":44, "age_reference":true, "TCL":"LP","TFC":"TBIL","test_name":"Total Bilirubin", "unit":"umol/L"},
    {"id": 16, "age_id":1, "reference_id":46, "age_reference":true, "TCL":"LP","TFC":"ALKP","test_name":"Alkaline Phosphatase ", "unit":"IU/L"},
    {"id": 17, "age_id":44, "reference_id":58, "age_reference":true, "TCL":"LP","TFC":"ALT","test_name":" Alanine Aminotransferase", "unit":"IU/L"},
    {"id": 18, "age_id":4, "reference_id":61, "age_reference":true, "TCL":"LP","TFC":"GGT","test_name":"Gamma-Glutamyl transferase  ", "unit":"IU/L"},
    {"id": 19, "age_id":4, "reference_id":71, "age_reference":true, "TCL":"BP","TFC":"Ca","test_name":"Calcium ", "unit":"mmol/L"},
    {"id": 20, "age_id":4, "reference_id":74, "age_reference":true, "TCL":"BP","TFC":"CCA","test_name":"Corrected Calcium (calculation)", "unit":"mmol/L"},
    {"id": 21, "age_id":12, "reference_id":77, "age_reference":true, "TCL":"BP","TFC":"Phos","test_name":"Phosphate", "unit":"mmol/L"},
    {"id": 22, "age_id":0, "reference_id":81, "age_reference":false, "TCL":"MG","TFC":"MG","test_name":"Magnesium", "unit":"mmol/L"},
    {"id": 23, "age_id":0, "reference_id":82, "age_reference":false, "TCL":"VID","TFC":"VID2","test_name":"Vitamin D", "unit":"nmol/L"},
    {"id": 24, "age_id":0, "reference_id":83, "age_reference":false, "TCL":"TNX1","TFC":"TNHS","test_name":"Troponin", "unit":"ng/L"},
    {"id": 25, "age_id":0, "reference_id":84, "age_reference":false, "TCL":"BNPL","TFC":"BNPL","test_name":"NT pro BNP", "unit":"pg/L"},
];

export function getAllPatientTestNames() { 
    var map = {}; 
    for (var i=0; i<data.length; i++) { 
        map[data[i].TFC] = data[i].id; 
    }
    return map; 
}
